                ...
                <div class="flex justify-between items-center pt-6 border-t border-gray-700">
                  ...
                  <div class="flex space-x-4">
                    <button
                      ...
                      @click="resetForm"
                      :disabled="loading"
                      class="px-4 py-2 border border-gray-600 text-sm font-medium rounded-lg text-gray-300 bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200 disabled:opacity-50"
                    >
                      Restablecer
                    </button>
                    <button
                      ...
                      class="px-6 py-2 border border-transparent text-sm font-medium rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
