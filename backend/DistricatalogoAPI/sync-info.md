Este es el servicio que utiliza el proceso que procesa los datos de gecom y envia los productos a la api
...
necesitamos endpoints para cumplir con todas estas acciones, iniciar sesión, y logeando progreso, etc.

Te paso lo que tiene la api vieja para cumplir con esto, el login ya lo tenemos es el mismo
