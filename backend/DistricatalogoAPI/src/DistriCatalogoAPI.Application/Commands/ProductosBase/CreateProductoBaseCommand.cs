...
{
    public class CreateProductoBaseCommand : IRequest<CreateProductoBaseCommandResult>
    {
        ...
        // Removido: AdministradoPorEmpresaId - se establece automáticamente desde el usuario
    }

    public class CreateProductoBaseCommandResult
    {
